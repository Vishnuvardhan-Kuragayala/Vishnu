...
public class AimController {
	...
	public ModelAndView addItem(@ModelAttribute("item") Item item,@RequestParam("lid") Integer lid) throws Exceptionn
	{
	...
	public ModelAndView SearchLockerr(@ModelAttribute("searchlockerr")Locker lockerr,@RequestParam("lockerId")int lockerr_id) throws Exceptionn
	{
		Locker Lockerlit;
