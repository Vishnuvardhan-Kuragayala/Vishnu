 ...
 <div class="panel panel-primary">
  ...
  <form class="form-horizontal col-sm-offset-4" id="form" action="addLocker" method="post" modelAttribute="locker"">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Item Id :</label>
      <div class="col-sm-4">          
        <input type="text" class="form-control" id="name" placeholder="Enter the item id" name="item_id">
  </div>
 
   
     <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">batchnumber :</label>
      <div class="col-sm-4">          
        <input type="text" class="form-control" id="name" placeholder="Enter the batchnumber" name="item_batchnumber">
  </div>
